...
if(isset($_POST['add_product']))
{
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `ym`( image) VALUES( '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `ym` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
      header('location:other14.php');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `ym` SET  image = '$update_p_image' WHERE id = '$update_p_id'");
...
h1{
  ...
  <body>
    <div class="container-scroller">
      <div class="row p-0 m-0 proBanner" id="proBanner">
        <div class="col-md-12 p-0 m-0">
          <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center justify-content-between"><a href="admin.php"><i class="mdi mdi-home me-3 text-white"></i></a>
      ...
      <center><a href="admin.php"><img src="images/y8.jpg" height="30px" width=30px" margin-left="50px"></a>  <a class="navbar-brand brand-logo  " href="admin.php"><h2>YM Fashion </h2></a></center>
      ...
      <div class="container-fluid page-body-wrapper">
        <!-- partial:partials/_sidebar.html --> <nav class="sidebar sidebar-offcanvas bg-gradient-danger"  id="sidebar">
         ...
         <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item"> <a class="nav-link" href="other14.php"><h3>Other</h3></a></li></h1>
                </ul>
              </div>
            </li>
            <li class="nav-item">
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `ym`");
         ...
         <tr style="background: white;">
            <td><img src="uploaded_img/<?php echo $row['image']; ?>" height="100" alt=""></td>
             <td>
               <a href="other14.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="other14.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `ym` WHERE id = $edit_id");
