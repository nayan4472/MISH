   ...
   <table>
      ...
      <tbody>
         ...
         ?>
            ...
            <td>
               <a href="ocancel18.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure cancel your order?');"> <i class="fas fa-trash"></i> Cancel Order </a>
