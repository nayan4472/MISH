...
<section class="gallery" id="gallery">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="images/mordern1.jpg" alt="">
         </div>
        ...
        <div class="box">
            <img src="images/mordon3.jpg" alt="">
      </div>

        <div class="box">
            <img src="images/mordon4.jpg" alt="">
       </div>
        ...
        <div class="box">
            <img src="images/mordon6.jpg" alt="">
        </div>

        <div class="box">
            <img src="images/mordon7.jpg" alt="">
        </div>

        <div class="box">
            <img src="images/mordon8.jpg" alt="">
        </div>
