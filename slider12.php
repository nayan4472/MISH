...
if(isset($_POST['add_product']))
{
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `slider1`( image) VALUES( '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `slider1` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `slider1` SET  image = '$update_p_image' WHERE id = '$update_p_id'");
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `slider1`");
...
<section class="edit-form-container">
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `slider1` WHERE id = $edit_id");
