...
$conn=mysqli_connect("localhost","root","","about1");
...
if(isset($_POST['add_product']))
{
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `about1`( image) VALUES( '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `about1` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `about1` SET  image = '$update_p_image' WHERE id = '$update_p_id'");
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `about1`");
         ...
         <tr style="background: white;">
            <td><img src="uploaded_img/<?php echo $row['image']; ?>" height="100" alt=""></td>
             <td>
               <a href="about1.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="about1.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `about1` WHERE id = $edit_id");
