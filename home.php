   ...
   <body style="background-color:skyblue">
     ...
     <form method="POST" action="search.php">
    	...
    	if(mysqli_num_rows($q) > 0)
            {
               ...
               {
         ?>
        <td><img src="images/<?php echo $row['image']; ?>" class="d-block w-100" style="height: 700px; width:100%"></td>       
         <?php
            };    
            }
            else
      ...
      <section class="home-about">
         ...
         <div class="image">
            <!-- <img src="images/ym1.jpeg" alt=""> -->
            <?php 
    	$con=mysqli_connect("localhost","root","","ym");

    	$q = mysqli_query($con, "SELECT * FROM `ym`");
    	if(mysqli_num_rows($q) > 0)
            {
               while($row = mysqli_fetch_assoc($q))
               {
         ?>
        <td><img src="images/<?php echo $row['image']; ?>" class="d-block w-100" style="height: 500px; width:100px"></td>       
         <?php
            };    
            }
            else
