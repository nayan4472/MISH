...
if(isset($_POST['add_product']))
{
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `slider`( image) VALUES( '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `slider` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `slider` SET  image = '$update_p_image' WHERE id = '$update_p_id'");
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2"><h3>Khalas Yash</span>
                  <span class="text-secondary text-small"><h3>yash123@gmail.com</span>
                </div>
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `slider`");
...
<section class="edit-form-container">
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `slider` WHERE id = $edit_id");
