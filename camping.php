...
<div class="heading" style="background:url(images/header-bg-1.png) no-repeat">
  <center> <h1 class="h">All Wears</h1></center>
</div>
...
if(isset($_POST['add_to_cart'])){
  ...
  $select_cart = mysqli_query($conn, "SELECT * FROM `home23` WHERE name = '$product_name'");

  if(mysqli_num_rows($select_cart) > 0){
     $message[] = 'product already added to cart';
  }else{
     $insert_product = mysqli_query($conn, "INSERT INTO `home23`(name, image ) VALUES('$product_name',  '$product_image' )");
...
?>
  ...
  <?php
      ...
      <form action="home23.php" method="post">
         <div class="box" style="background: white;">
            <img src="uploaded_img/<?php echo $fetch_product['image']; ?>" alt="">
            <h3><?php echo $fetch_product['name']; ?></h3> 
              <input type="hidden" name="product_image" value="<?php echo $fetch_product['image']; ?>">
              <div class="content">
                    <a href="camping.php" class="btn">see more</a>
            </div>
